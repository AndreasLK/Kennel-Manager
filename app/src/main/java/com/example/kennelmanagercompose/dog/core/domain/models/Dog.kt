...
data class Dog(
    ...
    val workOverrides: com.example.kennelmanagercompose.dog.session.domain.config.DogWorkOverrides = _root_ide_package_.com.example.kennelmanagercompose.dog.session.domain.config.DogWorkOverrides()
) : Entity