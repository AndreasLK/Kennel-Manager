package com.example.kennelmanagercompose.dog.session.domain.services

import com.example.kennelmanagercompose.dog.session.domain.enums.SessionStatus
import com.example.kennelmanagercompose.dog.session.domain.models.Session
import com.example.kennelmanagercompose.dog.core.domain.models.Dog
import com.example.kennelmanagercompose.dog.session.domain.config.RunRules
import com.example.kennelmanagercompose.dog.session.domain.config.WorkRules
import com.example.kennelmanagercompose.dog.session.domain.models.RunScore
...
object ReadyToRunCalculator {
    ...
    private var sessionData: Map<LocalDate, Map<String, List<com.example.kennelmanagercompose.dog.session.domain.enums.SessionStatus>>> = emptyMap()

    fun updateSessions(allSessions: List<com.example.kennelmanagercompose.dog.session.domain.models.Session>) {
        val newMap = mutableMapOf<LocalDate, MutableMap<String, MutableList<com.example.kennelmanagercompose.dog.session.domain.enums.SessionStatus>>>()
